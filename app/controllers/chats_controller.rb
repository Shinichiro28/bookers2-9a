class ChatsController < ApplicationController
  def show
    ...
    #これによって、AさんBさんに共通のroom_idが存在していれば、その共通のroom_idとBさんのuser_idがuser_room変数に格納されている(1レコード)。存在しなければ、nilになる。
    ...
    unless user_rooms.nil?
      ...
      @room = Room.new
      @room.save
      #採番したroomのidを使って、user_idのレコードを２人分(Aさん用、Bさん用)作る(=AさんとBさんに共通のroom_idを作る)
